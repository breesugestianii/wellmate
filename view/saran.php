    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <a href="index.php?c=Beranda" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg">
                    <i class="fas fa-chart-line"></i>
                    <span>Beranda</span>
                </a>

                <a href="index.php?c=Tracking" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg">
                    <i class="fas fa-glass-water"></i>
                    <span>Tracking Minum</span>
                </a>

                <a href="index.php?c=Saran" class="flex items-center space-x-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-lg">
                    <i class="fas fa-running"></i>
                    <span class="font-medium">Saran Aktivitas</span>
                </a>
